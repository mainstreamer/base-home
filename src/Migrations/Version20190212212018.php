 ...
 */
final class Version20190212212018 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE place (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, address VARCHAR(255) DEFAULT NULL, INDEX IDX_741D53CDA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tariff (id VARCHAR(255) NOT NULL, type_id VARCHAR(255) DEFAULT NULL, user_id VARCHAR(255) DEFAULT NULL, price INT DEFAULT NULL, description LONGTEXT DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_9465207DC54C8C93 (type_id), INDEX IDX_9465207DA76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meter (id VARCHAR(255) NOT NULL, type_id VARCHAR(255) DEFAULT NULL, unit_id VARCHAR(255) DEFAULT NULL, place_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) NOT NULL, INDEX IDX_5E010CAEC54C8C93 (type_id), INDEX IDX_5E010CAEF8BD700D (unit_id), INDEX IDX_5E010CAEDA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meter_tariff (meter_id VARCHAR(255) NOT NULL, tariff_id VARCHAR(255) NOT NULL, INDEX IDX_1BB2FE976E15CA9E (meter_id), INDEX IDX_1BB2FE9792348FD2 (tariff_id), PRIMARY KEY(meter_id, tariff_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE picture (id VARCHAR(255) NOT NULL, original_name VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, created DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE indication (id VARCHAR(255) NOT NULL, meter_id VARCHAR(255) DEFAULT NULL, tariff_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, value INT NOT NULL, date DATETIME NOT NULL, text_date VARCHAR(255) NOT NULL, unit VARCHAR(255) DEFAULT NULL, file VARCHAR(255) DEFAULT NULL, INDEX IDX_D15065D76E15CA9E (meter_id), INDEX IDX_D15065D792348FD2 (tariff_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE bill (id VARCHAR(255) NOT NULL, place_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, amount INT DEFAULT NULL, period DATETIME DEFAULT NULL, text_period VARCHAR(255) NOT NULL, status VARCHAR(255) NOT NULL, date DATETIME NOT NULL, text_date VARCHAR(255) NOT NULL, type VARCHAR(255) DEFAULT NULL, note LONGTEXT DEFAULT NULL, actually_paid INT DEFAULT NULL, pay_date DATETIME DEFAULT NULL, pay_date_text VARCHAR(255) DEFAULT NULL, file VARCHAR(255) DEFAULT NULL, is_paid TINYINT(1) NOT NULL, INDEX IDX_7A2119E3DA6A219 (place_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE meter_type (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, icon VARCHAR(32) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE unit (id VARCHAR(255) NOT NULL, name VARCHAR(255) NOT NULL, description VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id VARCHAR(255) NOT NULL, picture_id VARCHAR(255) DEFAULT NULL, email VARCHAR(255) NOT NULL, password VARCHAR(255) NOT NULL, first_name VARCHAR(255) NOT NULL, last_name VARCHAR(255) NOT NULL, roles VARCHAR(255) DEFAULT NULL, profile_pic VARCHAR(255) DEFAULT NULL, token VARCHAR(255) DEFAULT NULL, enabled TINYINT(1) DEFAULT \'0\' NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), UNIQUE INDEX UNIQ_8D93D649EE45BDBF (picture_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE tariff_type (id VARCHAR(255) NOT NULL, user_id VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, INDEX IDX_2BBAEAA7A76ED395 (user_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE file_upload (id VARCHAR(255) NOT NULL, bill_id VARCHAR(255) DEFAULT NULL, original_name VARCHAR(255) DEFAULT NULL, name VARCHAR(255) DEFAULT NULL, path VARCHAR(255) NOT NULL, created DATETIME NOT NULL, INDEX IDX_AFAAC0A01A8C12F5 (bill_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        $this->addSql('ALTER TABLE place ADD CONSTRAINT FK_741D53CDA76ED395 FOREIGN KEY (user_id) REFERENCES user (id)');
        $this->addSql('ALTER TABLE tariff ADD CONSTRAINT FK_9465207DC54C8C93 FOREIGN KEY (type_id) REFERENCES tariff_type (id) ON DELETE CASCADE');
        ...
        $this->addSql('ALTER TABLE indication ADD CONSTRAINT FK_D15065D792348FD2 FOREIGN KEY (tariff_id) REFERENCES tariff (id) ON DELETE SET NULL');
