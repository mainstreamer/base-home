 ...
 */
final class Version20200511104210 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card ADD user_id VARCHAR(255) DEFAULT NULL, ADD first_digits VARCHAR(2) NOT NULL, ADD bank VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE card DROP user_id, DROP first_digits, DROP bank');
    }
}
